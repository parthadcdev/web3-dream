  ...
  create: [
    ...
    body('rawMaterials')
      ...
      .custom((value) => {
        ...
        return value.every((material: any) => 
...
export const nftValidation = {
  mint: [
    ...
    body('complianceStandards')
      ...
      .custom((value) => {
        if (!Array.isArray(value)) return false;
        return value.every((standard: any) => 
